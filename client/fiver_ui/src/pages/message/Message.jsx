...
const Message = () => {
  ...
  const check = conversation?.filter((item) => item.id === id);
  useEffect(() => {
    refetch();
  }, [id]);
  return (
                  ...
                  <div className="header-message">
                    <div className="left">
                      ...
                      <p style={{ color: "#000000" }}>
                        ...
                        | Local time:{" "}
                        {messages &&
                          moment(messages[messages?.length - 1])?.format(
                            "DD MMMM YYYY"
                          )}
                      </p>
                    </div>
                    <div className="right">
                      {check[0]?.ratingStar ? (
                        <svg
                          onClick={() => ratingStar.mutate(check[0].id)}
                          width="20"
                          height="20"
                          viewBox="0 0 16 15"
                          xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div className="messages">
                      <div className="security">
                        <div className="wrap-sec">
                          ...
                          <p>
                            For added safety and your protection, keep payments
                            and communications within Fiverr
                          </p>
                        </div>
                      </div>
